...
const LOOKS = [
  ...
  },
  {
    id: 3,
    image:
      "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=2036&auto=format&fit=crop",
    title: "Bridal Suite",
  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        {/* HEADER: Added Gold Subtitle "THE STYLE EDIT" */}
        <div className="flex flex-col items-center justify-center mb-16 gap-6 text-center">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-[#1B2A4E] leading-tight uppercase tracking-tight">
              SHOP THE LOOK
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-[800px] md:h-[600px]">
          ...
          <div className="md:col-span-7 relative group overflow-hidden rounded-sm bg-[#fbf7ed]">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <p className="text-[10px] tracking-[0.2em] uppercase opacity-80 mb-6">
                {LOOKS[0].items}
              </p>
              <Link
                href={LOOKS[0].link}
                className="inline-flex items-center gap-2 bg-white text-[#1B2A4E] px-6 py-3 text-[10px] font-bold uppercase tracking-widest hover:bg-[#D4AF37] hover:text-white transition-all"
              >
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            {LOOKS.slice(1).map((look) => (
              <div
                key={look.id}
                className="relative flex-1 group overflow-hidden rounded-sm bg-[#fbf7ed]"
              >
                <img
                  src={look.image}
                  alt={look.title}
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <Link
                    href={look.link}
                    className="text-[9px] font-bold uppercase tracking-widest border-b border-white/50 hover:border-[#D4AF37] hover:text-[#D4AF37] transition-all pb-1"
                  >
                    Explore
                  </Link>
                </div>
